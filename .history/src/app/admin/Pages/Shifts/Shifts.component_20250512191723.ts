...
import { ShiftDialogComponent } from '../../Dialogs/ShiftDialog/ShiftDialog.component';
...
export class ShiftsComponent implements OnInit {
  ...
  @ViewChild(ShiftDialogComponent)
  ShiftDialogComponentChild!: ShiftDialogComponent;
  openNewShift() {
    this.submitted = false;
    this.ShiftDialogComponentChild.openNewShift();
  }
}
